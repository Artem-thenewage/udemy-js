...
// Если массив в первом аргументе пустой - то функция возвращает строку 'Нет доступных валют'. Функция возвращает 
...
function availableCurr(arr, missingCurr) {
    ...
    const availableNow = arr.filter(cur => cur != missingCurr);
    availableNow.forEach(element => {
        res += element + '\n';
    });
    return res;
}
